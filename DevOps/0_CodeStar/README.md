...
1. Type `uni-api` followed by a unique suffix (which will be your participant number)  as the **Project name**, select **AWS CodeCommit** as the repository, and click the **Next** button in the lower right corner of the browser window to proceed.
